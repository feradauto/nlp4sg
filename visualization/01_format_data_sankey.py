...
def extract_tasks_methods(df_labels_task):    
...
def common_tasks(df_processed_group,df_labels_task):
    ...
    df_labels_task.loc[df_labels_task.ID=='ghosh-etal-2020-iitp']
...
def get_names_and_order(df_sankey):
...
def main():
    ...
    df_labels_task=extract_tasks_methods(df_labels_task)
    ...
    order_dict,order_df=get_names_and_order(df_sankey)

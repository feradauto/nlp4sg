...
## use "text-davinci-002" to use GPT Instruct text-davinci-002 and get best results
## otherwise use facebook/bart-large-mnli
#python $base_folder/pipeline/02_unsdg_classification.py --model "text-davinci-002"
...
python $base_folder/pipeline/03_task_extraction.py #--model "text-davinci-002"
python $base_folder/pipeline/04_method_extraction.py #--model "text-davinci-002"
